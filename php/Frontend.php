...
class Frontend {
	...
	private function get_footer_svgs() {
		...
		<svg width="0" height="0" class="hidden" style="display: none;">
			...
			<symbol aria-hidden="true" data-prefix="fab" data-icon="share" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" id="has-share"><path fill="currentColor" d="M512 208L320 384H288V288H208c-61.9 0-112 50.1-112 112c0 48 32 80 32 80s-128-48-128-176c0-97.2 78.8-176 176-176H288V32h32L512 208z"/></svg></symbol>
		</svg>
		<?php
	}
