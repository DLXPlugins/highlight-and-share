...
(function () {
  ...
  var getPageParams = function getPageParams() {
    var params = {};
  ...
  if (null !== elements) {
    ...
    var hasHandleSelectEvents = function hasHandleSelectEvents(event) {
      ...
      var _getPageParams = getPageParams(),
    ...
    elements.forEach(function (element) {
      ...
      if (element.classList.contains('has-content-area')) {
        element.parentElement.addEventListener('mouseup', function (event) {
          hasHandleSelectEvents(event);
        });
        return;
      }
  ...
  if (null !== inlineElements) {
    ...
    var hasHandleInlineEvents = function hasHandleInlineEvents(event, element) {
      ...
      var _getPageParams2 = getPageParams(),
  ...
  if (null !== ctsElements) {
    ctsElements.forEach(function (element) {
      element.addEventListener('click', function (event) {
        ...
        var _getPageParams3 = getPageParams(),
