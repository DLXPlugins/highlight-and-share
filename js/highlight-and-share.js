jQuery( document ).ready( function( $ ) {
	...
	var has_display = function( text, title, link, e ) {
		...
		$children = wrapper_clone.find( '.has_whatsapp, .has_xing, .has_pinterest, .has_linkedin, .has_facebook, .has_twitter, .has_copy, .has_email, .has_reddit' );
	...
	var cts_display = function( text, title, link, e ) {
		...
		$children = wrapper_clone.find( '.has_whatsapp, .has_facebook, .has_twitter, .has_copy, .has_email, .has_reddit' );
		$.each( $children, function( index, item ) {
			var div = $( this );
			var url = div.find( 'a' ).attr( 'href' );
			url = url.replace( '%url%', encodeURIComponent( link ) );
